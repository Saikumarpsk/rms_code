...
//           $long = $val1["asset_loc_long"];
			...
			<ul class='sidebar-menu' data-widget='tree'>  
                         <li id='cls-active".$val1['asset_id']."' class=''> <a href='javascript:void(0);' onclick=comcheck('".$val1["asset_id"] ."')><i class='fa fa-circle text-green'></i><span>" .$val1["asset_name"] ."</span></a> </li>
                     </ul>";
